...
void fillCoefficients(Coeff* coeff) {
    ...
    //mid2s b = 1.0e-03 * [ 0.4232    0   -0.8464    0    0.4232]
    coeff->m2_b[0] = float_to_s7x16(.0004232);

    //mid2s a
    coeff->m2_a[0] = float_to_s7x16();
    coeff->m2_a[1] = float_to_s7x16();
    coeff->m2_a[2] = float_to_s7x16();

    //mid1s b =
    coeff->m1_b[0] = float_to_s7x16();
    coeff->m1_b[1] = float_to_s7x16();
    coeff->m1_b[2] = float_to_s7x16();

    //mid1s a
    coeff->m1_a[0] = float_to_s7x16();
    coeff->m1_a[1] = float_to_s7x16();
    coeff->m1_a[2] = float_to_s7x16();

    //lows b =
    coeff->l_b[0] = float_to_s7x16();
    coeff->l_b[1] = float_to_s7x16();
    coeff->l_b[2] = float_to_s7x16();

    //lows a
    coeff->l_a[0] = float_to_s7x16();
    coeff->l_a[1] = float_to_s7x16();
    coeff->l_a[2] = float_to_s7x16();
}
